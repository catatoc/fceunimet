    ...
    return (
        <> 
            <lu className="Lu-card-ing">
                <li className="Li-card-ing"><p className="p-Card-School">Ingenieria Civil</p><img src={"https://www.udg.co.cu/cmap/sistemas_operativos/administracion_memoria/Traduccion%20de%20DV%20a%20DR/images/memoria_virtual2.png"} className="img"/></li>
                <li className="Li-card-ing"><p className="p-Card-School">Ingenieria Mecanica</p><img src={"https://www.udg.co.cu/cmap/sistemas_operativos/administracion_memoria/Traduccion%20de%20DV%20a%20DR/images/memoria_virtual2.png"} className="img"/></li>
